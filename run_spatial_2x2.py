...
from nvmd_v3 import StructuredSpectralNVMD
from run_three_arms import ArmDataset, dump_atomic, evaluate, set_seed
...
def main():
    ...
    ap.add_argument("--out", default="spatial_2x2_results.json")
    args = ap.parse_args()
