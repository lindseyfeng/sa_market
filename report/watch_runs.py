...
PHASES = [("results/spatial_2x2_results.json","spatial",12, "cfg"),
          ("results/stability_results.json", "zoo",    24, "arm"),
          ("results/dose_results.json",      "dose",   12, "arm")]
LOGS = ["logs/spatial.log", "logs/stability.log", "logs/dose.log"]
...
while True:
    ...
    alive = subprocess.run(["pgrep", "-f", "run_three_arms|run_spatial_2x2"],
